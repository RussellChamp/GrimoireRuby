...
#'Dispel Good', 'Dispel Law', 'Fear', 'Inflict Serious Wounds', 'Invisibility, Greater', 'Poison', 'Resounding Blow', 'Slay Living', 'Summon Monster IV', 
	...
	@spells_arcane_level_1 = ['Beguiling Gift', 'Borrow Skill', 'Dancing Lantern', 'Feather Step', 'Flare Burst', 'Innocence', 'Invigorate', 'Memory Lapse', 'Restful Sleep', 'Saving Finale', 'Share Language', 'Solid Note', 'Timely Inspiration', 'Touch of Gracelessness', 'Vanish', 'Alter Winds', 'Feather Fall', 'Shocking Grasp', 'Expeditious Excavation', 'Grease', 'Stone Fist', 'Burning Hands', 'Hydraulic Push', 'Obscuring Mist', 'Touch of the Sea', 'Ant Haul', 'Break', 'Crafter\'s Curse', 'Crafter\'s Fortune', 'Gravity Bow', 'Sculpt Corpse', 'Stumble GapF', 'Rejuvenate Eidolon, Lesser', 'Unfetter', 'Ill Omen', 'Mask Dweomer']

	@spells_arcane_level_2 = ['Blood Biography', 'Cacophonous Call', 'Create Treasure Map', 'Dust of Twilight', 'Enter Image', 'Gallant Inspiration', 'Ghostbane Dirge', 'Hidden Speech', 'Honeyed Tongue', 'Versatile Weapon', 'Elemental Speech', 'Elemental Touch', 'Resist Energy', 'Summon Monster II', 'Glide', 'Gust of Wind', 'Levitate', 'Whispering Wind', 'Acid Arrow', 'Create PitF', 'Glitterdust', 'Shatter', 'Stone Call', 'Burning Gaze', 'Fire Breath', 'Flaming Sphere', 'Pyrotechnics', 'Scorching Ray', 'Accelerate Poison', 'Fog Cloud', 'Slipstream', 'Arrow Eruption', 'Create Treasure MapM', 'Share Language', 'Create Pit', 'Evolution Surge, Lesser', 'Summon Eidolon', 'Feast of Ashes', 'Fester', 'Perceive Cues', 'Pox Pustules', 'Vomit Swarm']

	@spells_arcane_level_3 = ['Arcane Concordance', 'Campfire Wall', 'Coordinated Effort', 'Elemental Speech', 'Feather Step, Mass', 'Invigorate, Mass', 'Jester\'s Jaunt', 'Purging Finale', 'Reviving Finale', 'Seek Thoughts', 'Thunderous Drums', 'Draconic Reservoir', 'Elemental Aura', 'Protection From Energy', 'Cloak of Winds', 'Fly', 'Gaseous Form', 'Lightning Bolt', 'Wind Wall', 'Shifting Sand', 'Spiked Pit', 'Stinking Cloud', 'Fireball', 'Flame Arrow', 'Aqueous Orb', 'Hydraulic Torrent', 'Sleet Storm', 'Water Breathing', 'Blood Biography', 'Devolution', 'Enter Image', 'Pain Strike', 'Twilight Knife', 'Versatile Weapon', 'Evolution Surge', 'Rejuvenate Eidolon', 'Cup of Dust', 'Guiding Star', 'Nature\'s Exile', 'Screech', 'Share Senses']

	@spells_arcane_level_4 = ['Denounce', 'Discordant Blast', 'Ghostbane Dirge, Mass', 'Heroic Finale', 'Treasure Stitching', 'Wandering Star Motes', 'Detonate', 'Dragon\'s Breath', 'Elemental Body I', 'Summon Monster IV', 'Ball Lightning', 'River of Wind', 'Shout', 'Acid Pit', 'Calcific Touch', 'Stone Shape', 'StoneskinM', 'Fire Shield', 'Fire Trap', 'Firefall', 'Wall of Fire', 'Ice Storm', 'Solid Fog', 'Wall of Ice', 'Acid PitF', 'DetonateM', 'Moonstruck', 'Shadow Projection', 'Share Senses', 'True Form', 'Evolution Surge, Greater', 'Purified Calling', 'Transmogrify', 'Sleepwalk', 'Spite', 'Threefold Aspect']

	@spells_arcane_level_5 = ['Bard\'s Escape', 'Cacophonous Call, Mass', 'Cloak of Dreams', 'Deafening Song Bolt', 'Foe to Friend', 'Frozen Note', 'Phantasmal Web', 'Stunning Finale', 'Unwilling Shield', 'Elemental Body II', 'Planar Adaptation', 'Planar Binding, Lesser', 'Summon Monster V', 'Overland Flight', 'Suffocation', 'Hungry PitF', 'Passwall', 'Transmute Mud to Rock', 'Transmute Rock to Mud', 'Wall of Stone', 'Fire Snake', 'Geyser', 'Cloudkill', 'Cone of Cold', 'Hungry Pit', 'Life Bubble', 'Pain Strike, Mass', 'Treasure Stitching', 'Rejuvenate Eidolon, Greater', 'Banish Seeming', 'Rest Eternal']

	@spells_arcane_level_6 = ['Brilliant Inspiration', 'Deadly Finale', 'Euphoric Tranquility', 'Fool\'s Forbiddance', 'Getaway', 'Pied Piping', 'Elemental Body III', 'Planar Binding', 'Summon Monster VI', 'Chain Lightning', 'Sirocco', 'Acid Fog', 'Flesh to Stone', 'Move Earth', 'Stone to Flesh', 'Wall of IronM', 'Contagious Flame', 'Fluid Form', 'Freezing Sphere', 'Cloak of Dreams', 'Enemy Hammer', 'Unwilling Shield', 'Planar Adaptation, Mass', 'Fester, Mass', 'Swarm Skin']

	@spells_arcane_level_7 = ['Elemental Body IV', 'Planar Adaptation, Mass', 'Summon Monster VII', 'Control Weather', 'Fly, Mass', 'Rampart', 'Reverse Gravity', 'Statue', 'Delayed Blast Fireball', 'Firebrand', 'Vortex', 'Deflection', 'Expend', 'Phantasmal Revenge']

	@spells_arcane_level_8 = ['Planar Binding, Greater', 'Summon Monster VIII', 'Shout, Greater', 'Stormbolts', 'Iron Body', 'Wall of Lava', 'Incendiary Cloud', 'Horrid Wilting', 'Polar Ray', 'Seamantle', 'Euphoric Tranquility']

	@spells_arcane_level_9 = ['Gate', 'Suffocation, Mass', 'Winds of Vengeance', 'Clashing Rocks', 'World Wave', 'Fiery Body', 'Meteor Swarm', 'Tsunami', 'Tsunami', 'Wall of SuppressionM']
	...
	@spells_divine_level_1 = ['Ant Haul', 'Dancing Lantern', 'Alter Winds', 'Aspect of the Falcon', 'Bristle', 'Call Animal', 'Cloak of Shade', 'Detect Aberration', 'Expeditious Excavation', 'Feather Step', 'Flare Burst', 'Hydraulic Push', 'Keen Senses', 'Negate Aroma', 'Stone Fist', 'Touch of the Sea', 'Burst Bonds', 'Tireless Pursuit', 'Wrath', 'Challenge Evil', 'Ghostbane Dirge', 'Grace', 'Hero\'s Defiance', 'Honeyed Tongue', 'Knight\'s Calling', 'Rally Point', 'Veil of Positive Energy', 'Glide', 'Gravity Bow', 'Hunter\'s Howl', 'Lead Blades', 'Residual Tracking']

	@spells_divine_level_2 = ['Blessing of Courage and Life', 'Ghostbane Dirge', 'Grace', 'Instant Armor', 'Oracle\'s Burden', 'Share Language', 'Weapon of Awe', 'Accelerate Poison', 'Aspect of the Bear', 'Burning Gaze', 'Campfire Wall', 'Eagle Eye', 'Elemental Speech', 'Feast of Ashes', 'Glide', 'Lockjaw', 'Natural Rhythm', 'Pox Pustules', 'Scent Trail', 'Slipstream', 'Stone Call', 'Bloodhound', 'Castigate', 'Confess', 'Corruption Resistance', 'Flames of the Faithful', 'Follow Aura', 'Honeyed Tongue', 'Perceive Cues', 'Sacred BondF', 'Aura of Greater Courage', 'Bestow Grace', 'Fire of Entanglement', 'Light Lance', 'Paladin\'s Sacrifice', 'Righteous Vigor', 'Saddle Surge', 'Wake of Light', 'Allfood', 'Arrow Eruption', 'Chameleon Stride', 'Create Treasure Map', 'Guiding Star', 'Hide Campsite', 'Hunter\'s Eye', 'Protective Spirit', 'Versatile Weapon']

	@spells_divine_level_3 = ['Blood Biography', 'Borrow Fortune', 'Elemental Speech', 'Enter Image', 'Guiding Star', 'Nap StackM', 'Sacred Bond', 'Wrathful Mantle', 'Aqueous Orb', 'Cloak of Winds', 'Create Treasure Map', 'Cup of Dust', 'Feather Step, Mass', 'Hide Campsite', 'Hydraulic Torrent', 'Lily Pad Stride', 'Nature\'s Exile', 'Shifting Sand', 'Banish Seeming', 'Cast Out', 'Coordinated Effort', 'Fester', 'Hidden Speech', 'Hunter\'s Eye', 'Retribution', 'Righteous Vigor', 'Seek Thoughts', 'Ward the Faithful', 'Divine Transfer', 'Fire of Judgment', 'Ghostbane Dirge, Mass', 'Holy Whisper', 'Marks of Forbiddance', 'Sanctify Armor', 'Aspect of the Stag', 'Bloody Claws', 'Instant Enemy', 'Life Bubble', 'Strong Jaw', 'Tireless Pursuers', 'Venomous Bolt']

	@spells_divine_level_4 = ['Blessing of Fervor', 'Planar Adaptation', 'Rest Eternal', 'Spiritual Ally', 'Aspect of the Stag', 'Ball Lightning', 'Bloody Claws', 'Geyser', 'Grove of Respite', 'Life Bubble', 'Moonstruck', 'River of Wind', 'Strong Jaw', 'Thorn Body', 'True Form', 'Brand, Greater', 'Coward\'s Lament', 'Defile Armor', 'Denounce', 'Forced Repentance', 'Rebuke', 'Sanctify Armor', 'Shared Wrath', 'SleepwalkM', 'Tireless Pursuers', 'Blaze of Glory', 'Fire of Vengeance', 'King\'s Castle', 'Oath of Peace', 'Resounding Blow', 'Sacrificial Oath', 'Stay the Hand', 'Aspect of the Wolf', 'Blessing of the Salamander', 'Bow Spirit']

	@spells_divine_level_5 = ['Cleanse', 'Ghostbane Dirge, Mass', 'Life Bubble', 'Pillar of Life', 'Snake Staff', 'Treasure Stitching', 'Aspect of the Wolf', 'Blessing of the Salamander', 'Fire Snake', 'Rest Eternal', 'Threefold Aspect', 'Castigate, Mass', 'Resounding Blow', 'Unwilling Shield']
